...
plot(data, x_test, GPR_linear, "A: Linear Kernel (Dataset 1; Original)", "linear_1", (-5.5, 5.5), (0.002499, 0.002524), (-105, 105))
...
plot(data, x_test, GPR_rbf_fixed, "A: RBF Kernel (Dataset 1; Original)", "rbf_1", (-5.5, 5.5), (0.00245, 0.0053), (-105, 105))
...
GPR_linear = GaussianProcessRegressor(kernel=DotProduct(sigma_0=0, sigma_0_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_linear.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_linear, "A: Linear Kernel (Dataset 1; Undersampled)", "linear_1_un", (-5.5, 5.5), (0.00248, 0.00302), (-105, 105))

GPR_rbf_fixed = GaussianProcessRegressor(kernel=RBF(length_scale_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_rbf_fixed.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_rbf_fixed, "A: RBF Kernel (Dataset 1; Undersampled)", "rbf_1_un", (-5.5, 5.5), None, (-105, 105))
...
GPR_linear = GaussianProcessRegressor(kernel=DotProduct(sigma_0=0, sigma_0_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_linear.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_linear, "B: Linear Kernel (Dataset 2; Original)", "linear_2", (-5.5, 5.5), (0.002499, 0.002524), (-105, 105))

GPR_rbf_fixed = GaussianProcessRegressor(kernel=RBF(length_scale_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_rbf_fixed.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_rbf_fixed, "B: RBF Kernel (Dataset 2; Original)", "rbf_2", (-5.5, 5.5), (0.00245, 0.0053), (-105, 105))
...
GPR_linear = GaussianProcessRegressor(kernel=DotProduct(sigma_0=0, sigma_0_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_linear.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_linear, "B: Linear Kernel (Dataset 2; Undersampled)", "linear_2_un", (-5.5, 5.5), (0.00248, 0.00302), (-105, 105))

GPR_rbf_fixed = GaussianProcessRegressor(kernel=RBF(length_scale_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_rbf_fixed.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_rbf_fixed, "B: RBF Kernel (Dataset 2; Undersampled)", "rbf_2_un", (-5.5, 5.5), None, (-105, 105))
...
GPR_linear = GaussianProcessRegressor(kernel=DotProduct(sigma_0=0, sigma_0_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_linear.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_linear, "C: Linear Kernel (Dataset 3; Original)", "linear_3", (-5.5, 5.5), (0.002499, 0.002524), (-105, 105))

GPR_rbf_fixed = GaussianProcessRegressor(kernel=RBF(length_scale_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_rbf_fixed.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_rbf_fixed, "C: RBF Kernel (Dataset 3; Original)", "rbf_3", (-5.5, 5.5), (0.00245, 0.0053), (-105, 105))
...
plot(data, x_test, GPR_linear_rbf_white, "A: Linear+RBF+White Kernel (Dataset 3; Original)", "linear_rbf_white_3", (-5.5, 5.5), None, (-3, 3))
...
plot_break_axis(data_appendix, x_test, GPR_linear_rbf_white, "A: Linear+RBF+White Kernel (Dataset 3; Quadratic)", "linear_rbf_white_3_quad")
...
GPR_linear = GaussianProcessRegressor(kernel=DotProduct(sigma_0=0, sigma_0_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_linear.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_linear, "C: Linear Kernel (Dataset 3; Undersampled)", "linear_3_un", (-5.5, 5.5), (0.00248, 0.00302), (-105, 105))

GPR_rbf_fixed = GaussianProcessRegressor(kernel=RBF(length_scale_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_rbf_fixed.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_rbf_fixed, "C: RBF Kernel (Dataset 3; Undersampled)", "rbf_3_un", (-5.5, 5.5), None, (-105, 105))
...
GPR_linear = GaussianProcessRegressor(kernel=DotProduct(sigma_0=0, sigma_0_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_linear.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_linear, "D: Linear Kernel (Dataset 4; Original)", "linear_4", (-5.5, 5.5), (0.002499, 0.002524), (-105, 105))

GPR_rbf_fixed = GaussianProcessRegressor(kernel=RBF(length_scale_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_rbf_fixed.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_rbf_fixed, "D: RBF Kernel (Dataset 4; Original)", "rbf_4", (-5.5, 5.5), (0.00245, 0.0053), (-105, 105))
...
plot(data, x_test, GPR_linear_rbf_white, "B: Linear+RBF+White Kernel (Dataset 4; Original)", "linear_rbf_white_4", (-5.5, 5.5), None, (-3, 3))
...
plot_break_axis(data_appendix, x_test, GPR_linear_rbf_white, "B: Linear+RBF+White Kernel (Dataset 4; Quadratic)", "linear_rbf_white_4_quad")
...
GPR_linear = GaussianProcessRegressor(kernel=DotProduct(sigma_0=0, sigma_0_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_linear.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_linear, "D: Linear Kernel (Dataset 4; Undersampled)", "linear_4_un", (-5.5, 5.5), (0.00248, 0.00302), (-105, 105))

GPR_rbf_fixed = GaussianProcessRegressor(kernel=RBF(length_scale_bounds="fixed") + WhiteKernel(noise_level=sigma ** 2, noise_level_bounds="fixed"), alpha=0)
GPR_rbf_fixed.fit(data[["x"]], data["y"])
plot(data, x_test, GPR_rbf_fixed, "D: RBF Kernel (Dataset 4; Undersampled)", "rbf_4_un", (-5.5, 5.5), None, (-105, 105))

"""Combine figure and save as TIFF"""
images = [Image.open("set_" + str(x) + ".png") for x in range(1, 5)]
...
images = [Image.open("set_" + str(x) + "_un.png") for x in range(1, 5)]
widths, heights = zip(*(i.size for i in images))
total_width = sum(widths)
max_height = max(heights)
new_im = Image.new('RGB', (total_width, max_height))
...
images = [Image.open("linear_" + str(x) + ".png") for x in range(1, 5)]
widths, heights = zip(*(i.size for i in images))
total_width = sum(widths)
max_height = max(heights)
new_im = Image.new('RGB', (total_width, max_height))
...
images = [Image.open("linear_" + str(x) + "_un.png") for x in range(1, 5)]
widths, heights = zip(*(i.size for i in images))
total_width = sum(widths)
max_height = max(heights)
new_im = Image.new('RGB', (total_width, max_height))
...
images = [Image.open("rbf_" + str(x) + ".png") for x in range(1, 5)]
widths, heights = zip(*(i.size for i in images))
total_width = sum(widths)
max_height = max(heights)
new_im = Image.new('RGB', (total_width, max_height))
...
images = [Image.open("rbf_" + str(x) + "_un.png") for x in range(1, 5)]
widths, heights = zip(*(i.size for i in images))
total_width = sum(widths)
max_height = max(heights)
new_im = Image.new('RGB', (total_width, max_height))
...
images = [Image.open("linear_rbf_white_" + str(x) + ".png") for x in range(3, 5)]
widths, heights = zip(*(i.size for i in images))
total_width = sum(widths)
max_height = max(heights)
new_im = Image.new('RGB', (total_width, max_height))
...
images = [Image.open("linear_rbf_white_" + str(x) + "_quad.png") for x in range(3, 5)]
widths, heights = zip(*(i.size for i in images))
total_width = sum(widths)
max_height = max(heights)
new_im = Image.new('RGB', (total_width, max_height))
